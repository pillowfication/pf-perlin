...
},{"..":2,"jquery":3,"pf-canvas":5}],2:[function(require,module,exports){
module.exports = require('./src/perlin.js')

},{"./src/perlin.js":8}],3:[function(require,module,exports){
/*!
...
},{"json-stringify-safe":4}],8:[function(require,module,exports){
...
function Perlin (options) {
  ...
  let len = dim - 1
  let min = options.min
  let lam = options.wavelength
  let oct = options.octaves
  let sca = 1 / options.octaveScale
  let per = options.persistence
  let int = options.interpolation
